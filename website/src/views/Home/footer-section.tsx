...
const FooterSection: React.FC<FooterSectionProps> = ({ id, title, image }) => {
  const scrollToTop = () => {
  ...
  return (
    <footer
      id={id}
      className="w-full bg-black flex flex-col justify-end z-50 relative p-4 sm:p-6 md:p-8 lg:p-12 h-screen"
    >
