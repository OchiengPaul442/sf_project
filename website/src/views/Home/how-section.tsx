...
const HowSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="solutions"
      className={`relative min-h-dvh snap-start py-20 sm:py-32 md:py-40 flex justify-center items-center bg-black overflow-hidden transition-opacity duration-1000 ${
